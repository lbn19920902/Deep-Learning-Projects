...
url = 'https://capfriendly.com/browse/active/'+str(sys.argv[1])+'/caphit/all/all/all/desc/'
new_url = url
page = 1
...
cap_df.to_csv('CapData_'+str(sys.argv[1])+'.csv', index=False, header=True, encoding='utf-8')
